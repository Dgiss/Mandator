...
const ModifyDocumentButton: React.FC<ModifyDocumentButtonProps> = ({
  ...
  return <>
      <Button variant="ghost" size="sm" className="h-8 w-8 p-0" onClick={handleClick} title="Modifier le document">
      ...
      if (!open) setEditingDoc(null);
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          <MarcheDocumentForm marcheId={document.marche_id} onDocumentSaved={handleDocumentSaved} editingDocument={isOpen ? document : null} setEditingDocument={setEditingDoc} />
        </DialogContent>
      </Dialog>
    </>;
};
