...
const MarcheTabsNavigation: React.FC<MarcheTabsNavigationProps> = ({ activeTab, onTabChange }) => {
  return (
    <div className="border-b sticky top-[69px] bg-white z-10 shadow-sm">
      <div className="container mx-auto">
        <div className="overflow-x-auto">
          <TabsList className="bg-transparent h-auto p-0 w-full justify-start">
            <TabsTrigger 
              value="apercu" 
              className="flex items-center whitespace-nowrap px-4 py-3 data-[state=active]:border-b-2 data-[state=active]:border-btp-blue rounded-none data-[state=active]:shadow-none"
